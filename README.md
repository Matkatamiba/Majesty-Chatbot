...
- On the left side, go to OAuth2. Under scopes, check the box for 'Bot' and then check 'Read Message History'. Go to URL Generator on the left side and check the same Bot and Read Message History.
